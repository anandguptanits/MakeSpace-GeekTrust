...
public class CCaveBookingHandler extends BookingHandler{

    public CCaveBookingHandler(MeetingRoomManager meetingRoomManager) {
    ...
    public MeetingRoom bookHandler(Interval interval, int capacity) {
        ...
        Optional<MeetingRoom> meetingRoomOptional=getAvailableRoomWithType(RoomType.C_CAVE,interval,capacity);
